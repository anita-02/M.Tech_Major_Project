from PCA_functions import get_data_dict, extract_feature, pca_analysis
import numpy as np
...
if __name__ == '__main__':
    ...
    z = pca_analysis(feature_vectors_norm_ch_1_2, feature_label_ch1_2, channel_names_ch1_2)
    # z = pca_analysis(feature_vectors_norm_ch3_4, feature_label_ch3_4, channel_names_ch3_4)
    # z = pca_analysis(feature_vectors_norm_ch_3_to_5, feature_label_ch_3_to_5, channel_names_ch_3_to_5)
    # z = pca_analysis(feature_vectors_norm_ch_1_to_4, feature_label_ch_1_to_4, channel_names_ch_1_to_4)
    # z = pca_analysis(feature_vectors_norm_ch_1_to_5, feature_label_ch_1_to_5, channel_names_ch_1_to_5)
