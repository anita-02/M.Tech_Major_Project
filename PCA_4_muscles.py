...
def pca_analysis(X, Y, ch):
    ...
    plt.figure()
    colors = ["magenta", "green", "blue", "cyan", "magenta", "green", "red", "black"]
...
def get_data_dict(folder_location, ):
...
if __name__ == '__main__':
    ...
    pca_analysis(feature_vectors_norm_ch_1_to_4, feature_label_ch_1_to_4, channel_names_ch_1_to_4)
    print("Done")
